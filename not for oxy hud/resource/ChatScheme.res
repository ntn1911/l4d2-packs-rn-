...
Scheme
{
	...
	BaseSettings
	{
		...
		Border.Bright					"0 0 0 196"	// the lit side of a control
		Border.Dark						"0 0 0 196"		// the dark/unlit side of a control
		Border.Selection				"128 128 128 196"			// the additional border color for displaying the default/selected button
		...
		Frame.BgColor					"0 0 0 128"	[$WIN32]
		Frame.BgColor					"0 0 0 128"		[$X360]
		Frame.OutOfFocusBgColor			"255 128 0 128"	[$WIN32]
		Frame.OutOfFocusBgColor			"255 128 0 128"		[$X360]
		...
		FrameGrip.Color2				"128 128 128 196"
		...
		GraphPanel.BgColor				"150 125 32 128"
		...
		ListPanel.TextBgColor				"64 64 64 64"
		ListPanel.BgColor					"TransparentBlack"
		ListPanel.SelectedTextColor			"Orange"
		ListPanel.SelectedBgColor			"black"
		ListPanel.SelectedOutOfFocusBgColor	"64 64 64 64"
		...
		SectionedListPanel.OutOfFocusSelectedBgColor	"64 64 64 64"
		...
		TextEntry.DisabledBgColor	"Orange"
		TextEntry.SelectedTextColor	"Orange"
		TextEntry.SelectedBgColor	"black"
		TextEntry.OutOfFocusSelectedBgColor	"64 64 64 64"
